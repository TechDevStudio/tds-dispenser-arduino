...
///////////////////// VARIABLES ////////////////////
lv_anim_t * AnmImgScan_Animation( lv_obj_t *TargetObject, int delay);
lv_anim_t * AnmImgSelect_Animation( lv_obj_t *TargetObject, int delay);
lv_anim_t * AnmImgPour_Animation( lv_obj_t *TargetObject, int delay);
lv_anim_t * AnmImgEnjoy_Animation( lv_obj_t *TargetObject, int delay);
...
lv_anim_set_values(&PropertyAnimation_0, 10, -10 );
...
ui_SC01Pulsera_screen_init();
ui_SC02Selection_screen_init();
ui_SC03Dispensar_screen_init();
ui_SC04Finalizar_screen_init();
ui____initial_actions0 = lv_obj_create(NULL);
lv_disp_load_scr( ui_SC01Pulsera);
}

void ui_destroy( void )
{ui_SC01Pulsera_screen_destroy();
ui_SC02Selection_screen_destroy();
ui_SC03Dispensar_screen_destroy();
ui_SC04Finalizar_screen_destroy();
}
